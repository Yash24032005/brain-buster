...
[![Vercel](https://img.shields.io/badge/Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://brain-buster-alpha.vercel.app/)
...
<table style="width: 100%;">
  <tr>
    <td style="width: 33%; text-align: center;">
      <img src="./screenshots/Home.png" alt="Home Screen" style="border-radius: 10px; border: 1px solid #334155;">
      <p><b>🏠 Home UI</b></p>
    </td>
    <td style="width: 33%; text-align: center;">
      <img src="./screenshots/quiz.png" alt="Quiz Interface" style="border-radius: 10px; border: 1px solid #334155;">
      <p><b>⏱️ Live Quiz</b></p>
    </td>
    <td style="width: 33%; text-align: center;">
      <img src="./screenshots/admin.png" alt="Admin Panel" style="border-radius: 10px; border: 1px solid #334155;">
